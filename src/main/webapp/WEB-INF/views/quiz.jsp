...
<body class="is-preload">
	<div id="page-wrapper">
		...
		<div id="header">
			...
			<!-- Logo -->
			<h1>
				<a href="index.html" id="logo">Recycle Map</a>
			</h1>
				...
				<div id="content">
					...
					<article>
						<div class="quiz">
							...
							<span><img src="resources/images/칫솔.jfif"></span> <br>
							<br> <label><input type="radio" name="question2"
								class="answer" data-correct="false"> O</label> <br>
							<c> <label><input type="radio" name="question2"
								class="answer" data-correct="true"> X</label> <span id="ans"
								style="display: none;">&nbsp&nbsp&nbsp&nbsp<strong>정답</strong></span>
							</c>
							<br>
							<p class="explanation" style="display: none;">
								해설 : 칫솔은 플라스틱류가 아닌 일반 쓰레기로 분류해야 한다. <br>
								<strong style="color: #A9A9A9">70% 이상이 플라스틱으로 이루어진 칫솔은
									최근 서울특별시 강동구에서 폐 칫솔을 모아 줄넘기, 플라스틱 화분 등으로 재활용하기 위해 <b
						...
						<div class="quiz">
							...
							<span><img src="resources/images/장독대.jpg" width="300px"
								height="300px"></span> <br>
							<br> <label><input type="radio" name="question3"
								class="answer" data-correct="false"> O</label> <br>
						...
						<div class="quiz">
							...
							<span><img src="resources/images/깨진유리병.jpg" width="300px"
								height="300px"></span> <br>
							<br> <label><input type="radio" name="question4"
								class="answer" data-correct="false"> O</label> <br>
							...
							<p class="explanation" style="display: none;">
								해설 : 깨진 유리는 신문지 등으로 충분히 감싼 후, 반드시 종량제 봉투에 배출해야 한다. <br>
								<strong style="color: #A9A9A9">단, 유리병이 아닌 일반 유리는 깨지지
									않더라도 재활용이 되지 않기에 꼭 일반 쓰레기로 배출해야 한다.</strong>
							</p>
						</div>
						...
						<div class="quiz">
							...
							<br> <label><input type="radio" name="question5"
								class="answer" data-correct="false"> X</label>
						...
						<div class="quiz">
							...
							<span><img src="" width="300px" height="300px"></span> <br>
							<br> <label><input type="radio" name="question6"
								class="answer" data-correct="false"> O</label> <br>
							...
							<p class="explanation" style="display: none;">
								해설 : 스티로폼은 전체가 흰 색인 것만 분리 배출이 가능하다. <br>
								<strong style="color: #A9A9A9">유색 플라스틱이나 이물질이 묻어 있는
									스티로폼, 무늬가 있거나 코팅된 스티로폼은 재활용이 어렵다.</strong>
							</p>
						</div>
						...
						<div class="quiz">
							...
							<span><img src="" width="300px" height="300px"></span> <br>
							<br> <label><input type="radio" name="question7"
								class="answer" data-correct="false"> O</label> <br>
						...
						<div class="quiz">
							...
							<br> <label><input type="radio" name="question8"
								class="answer" data-correct="false"> X</label>

							<p class="explanation" style="display: none;">
								해설 : 깨끗한 비닐류는 분리 배출 표시가 없다고 해도 재활용이 가능하다. <br>
								<strong style="color: #A9A9A9">일회용 봉투, 에어캡, 세탁소 비닐 같은
									경우에도 비닐로 재활용이 가능하지만 식품포장용 '랩'은 종량제 봉투에 버려 일반 쓰레기로 배출해야 한다. </strong>
							</p>
						</div>
						...
						<div class="quiz">
							...
							<span><img src="" width="300px" height="300px"></span> <br>
							<br> <label><input type="radio" name="question9"
								class="answer" data-correct="false"> O</label> <br>
